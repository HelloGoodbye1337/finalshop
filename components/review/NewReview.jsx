...
const NewReview = ({ product }) => {
  ...
  return (
    <div>
      <hr className="my-4" />
      <h1 className="text-black-500 review-title my-5 text-2xl">Ваш отзыв</h1>
      ...
      <button
        className="mt-3 mb-5 px-4 py-2 text-center inline-block text-white bg-blue-500 border border-transparent rounded-md hover:bg-blue-600 w-1/3"
